...
| *MacDonald & Watson*, 933 F.2d 35 · *Bank of New England*, 821 F.2d 844 · *Jewell*, 532 F.2d 697 · *Cincotta*, 689 F.2d 238 · *Veeck*, 293 F.3d 791 — all law.resource.org | Held, unread. ⚠ **None carries star pagination.** Five opinions that can confirm text and cannot confirm a page ([E47](../ledger/errata.md)) |
| *Johnson & Towers*, 741 F.2d 662 — **three copies** | ✅ **Read, 26 Aug 2026**, and the row that grouped it here was wrong about the shelf. law.resource.org and FindLaw captures carry **no star pagination**; a third, filed as `_second-copy`, is an **OpenJuris capture that does carry star pagination** and is **one page**, ending at `*664`. ⚠ 669 stays unconfirmed — the only paginated copy stops five pages short ([E66](../ledger/errata.md)) |
...
| *Global-Tech Appliances v. SEB*, 563 U.S. 754 — **govinfo U.S. Reports print** | ✅ **Read, 26 Aug 2026, and it settled its own pincite: 769 confirmed** for the two-part willful-blindness test. ⛔ The proposition it was cited **for** was wrong — "the constitutional ceiling" — and a correct page number carried it ([E65](../ledger/errata.md)) |
