...
the evidence base for the proposed enterprise scope (see [the definition](../docs/the_definition.md)
and [CURE 7 in the v3.5 queue](../audit/v3_5_cure_language.md)). It is a reference and an argument
support, not a finding of any offence — no offence yet exists in law, which is the project's point.
...
organisational power; (2) a material AI function; (3) a plausible connection to frontier capability
...
that is where the [2026 incident record](./press_corpus_july_august_2026.md) lives — then the
...
data, define its permissions, and place it inside defence, intelligence, health, financial, and
...
outside the law. The frontier is produced by chips, data centres, cloud access, models, deployment
...
governance pages. Corrections enter [the errata register](../ledger/errata.md).

*The argument this file supports: [the case](../docs/the_case.md) — personal, legal accountability
