#!/usr/bin/env python3
"""Emits packets/open_source.md verbatim from the template below.
Never edited by hand; regenerated. Pattern: template-emitting builder."""

OUT = "packets/open_source.md"

PACKET = r'''# The open source and academia lane — one page
