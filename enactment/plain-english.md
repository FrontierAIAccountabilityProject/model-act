---
title: "The statute, translated"
parent: For Legislatures
nav_order: 3
---

*SEC. 0–13 in plain language, beside what the statute actually says. Split from the front
page on 21 August 2026. The authoritative text is [`model_act_v3_4.txt`](../act/model-act.txt);
where this page and the statute differ, the statute governs and the difference is an
[erratum](../corrections/corrections.md). The argument this serves is [the case](../commentary/the-case.md).*
...
not the text; where this summary and [the statute](../act/model-act.txt) differ, the
statute controls, and the strict verification prompt in [Verify it](../commentary/the-case.md#verify-it) works
...
verbatim in [the adopted texts](../authorities/adopted-standards.md) — applied to
...
only new part is who it reaches. [Verify it](../commentary/the-case.md#verify-it).*


---

*Corrections to the project contact; they enter [the errata register](../corrections/corrections.md) with the fix attached and permanent credit.*
