...
vacancy [the census](./bill-census.md) finds in frontier statutes, appearing in a
...
works](../commentary/why-a-signature-works.md) records that Stewart Parnell's sentence came from a document he
...
[House language](../authorities/house-style.md) is about exactly this: a word that quietly assigns a role.
...
*Added 22 August 2026. Sources: [AISI incident report INC-2026-07-28-01](./incident-report.md),
...
**Read that against [the census](./bill-census.md): no enacted frontier statute in the United
...
[E15](../corrections/corrections.md) exists to resist.
...
disclosed the AISI intrusion ([the incident file § 5](./incident-report.md))
is outside it**, as he is outside every framework in [the census](./bill-census.md). And
...
[the census](./bill-census.md); reading note at
...
[the census](./bill-census.md) — but § 109 is drafted language for the problem this
...
| **§ 4a** — the breached party's investigation was blocked by commercial API safety filters | ✅ same source; corroborated by [Forescout](./commentary-sweep.md#g6--somebody-finally-asked-the-question-in-a-headline-and-stopped-at-the-company) |
...
| **§ 4a** — none of these disclosures was legally compelled | ⚠ **inference from [the census](./bill-census.md)**, which reads bills, not notification law |
...
email or a post.** [E15](../corrections/corrections.md) exists because this project once graded a claim on who
...
can tell us where this is wrong. They enter [the errata register](../corrections/corrections.md) with the fix
