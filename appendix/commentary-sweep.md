...
*Companion to [the bill census](./bill-census.md), which runs the same question over the
bills themselves, and to [the sponsors' file](../enactment/index.md), which states the finding both
files support. Terms follow [the house language rule](../authorities/house-style.md).*
...
[the adopted texts](../authorities/adopted-standards.md), which pins what the statutes say, and to
[the FDA reading notes](../filed-comments/fda-2024-d-4488.md), where the same
...
[E13](../corrections/corrections.md) records what that can cost. Nothing here is cited publicly until
...
[the adopted texts](../authorities/adopted-standards.md) before public use.*
...
**It opens with the comparison [the same conduct, prosecuted](../commentary/the-same-conduct.md) is built on**,
...
[the glossary](../authorities/glossary.md) uses:
...
3. **This is commentary, not law.** Every claim about what a statute contains must be
   ...
   [the adopted texts](../authorities/adopted-standards.md).
4. **The sweep was conducted through automated retrieval**, which
   [E13](../corrections/corrections.md) records failing on 21 August 2026 in a way that nearly put a
