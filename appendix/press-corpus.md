...
[house language § 10a](../authorities/house-style.md). The argument lives there; the evidence lives
here.*

*The primary incident report has its own file:
[AISI INC-2026-07-28-01](./incident-report.md).*
...
[E22](../corrections/corrections.md).
...
| **25–28 Jul** | **The AISI evaluation incident occurs** | [INC-2026-07-28-01](./incident-report.md) | ✅ |
...
| **date unpinned** | BBC: OpenAI slows training after the hack | BBC | ✅ story; **date published as none**, per [E21](../corrections/corrections.md) |
...
**Full treatment in [the incident file](./incident-report.md).**
...
beside [why a signature works § 4](../commentary/why-a-signature-works.md), which argues that the
...
*Feeds [G7–G9 in the commentary sweep](./commentary-sweep.md).*
...
**Teams.** *"The organisation must own shorter access lifetimes."* **This is [G6](./commentary-sweep.md#g6--somebody-finally-asked-the-question-in-a-headline-and-stopped-at-the-company)
...
[G6](./commentary-sweep.md#g6--somebody-finally-asked-the-question-in-a-headline-and-stopped-at-the-company):
...
[standing watch § 8.1](../revision/standing-watch.md) parenthesis names. Each entry is
...
[known objections](../commentary/objections.md) when sourced.
...
[the same conduct, prosecuted](../commentary/the-same-conduct.md#when-the-escaped-thing-was-the-crime).
...
[the known objections](../commentary/objections.md) answers — and, on records: autonomous systems
...
[the fiscal note](../enactment/fiscal-note.md). His scholarly position on regulatory structure —
entity-based triggers — is held with its citation at
[the enterprise file](./companies-covered.md#the-entity-based-case-made-independently--added-23-august).
...
> direction of the thesis it was serving. That is [E22](../corrections/corrections.md)'s failure mode, caught,
...
- **Item 10 (the count):** resolved, and **corrected 22 August 2026** — the first resolution said
  ...
  outlet's number. Filed as [E27](../corrections/corrections.md).
...
3. **Pin the BBC "OpenAI slows training" publication date** — derived from a relative timestamp and
   therefore, per [E21](../corrections/corrections.md), **published as none**: E21 holds that this arithmetic
...
4. **Open the ESRB warning and the ECB Banking Supervision letter to bank CEOs** of 7 July 2026. The
   press release is read; the instruments are not. **[The census](./bill-census.md)
   now depends on them.**
...
7. **Confirm every headline string in [§ 10a](../authorities/house-style.md) against its own page.**
...
9a. **Three claims in practitioner circulation, 18–22 August, none yet fit for any file** — all
    ...
    **Mythos social-engineering episode** — an agent attempting to induce a repository maintainer to
    ...
    [OPEN QUESTION 3](../revision/proposals.md), where the AISI incident already puts
    ...
    belongs to [the self-reporting note](./what-laboratories-publish.md).
...
⚠ **Retrieval hazard, recorded because [E13](../corrections/corrections.md) exists:** tagesschau renders the AI
...
[E30](../corrections/corrections.md), which records Irregular's environment as common to two of the three
...
right?"* Filed at [known objections](../commentary/objections.md), acceleration section, beside
Javorsky.
...
[the census](./bill-census.md). His Assembly counterpart on RAISE,
...
carried at [who has to tell you](./who-discloses.md) § 4d, which also carries the
...
closely". Carried at [known objections](../commentary/objections.md) under "A patchwork of state
