...
*Companion to [the adopted texts](../authorities/adopted-standards.md), which pins what the enacted statutes
say; to [the commentary sweep](./commentary-sweep.md), which asks whether anyone writing about
them has noticed; and to [the sponsors' file](../enactment/index.md), which states the finding
these rows are evidence for. Terms used here follow [the house language rule](../authorities/house-style.md).*
...
exemption from it — see [the case](../commentary/the-case.md#who-this-is-about).)*
...
[E15](../corrections/corrections.md) fixed what ✅ means for this project: **a ✅ requires that this project
...
modest one: [E13](../corrections/corrections.md) records automated retrieval nearly putting a false
correction into the evidence file, and [E14](../corrections/corrections.md) records two primary sources
...
**One provision worth flagging for the fiscal and torts topics.** Section 45, "Loss of equity," reads
...
pinned verbatim at [the adopted texts](../authorities/adopted-standards.md)
...
[the adopted texts](../authorities/adopted-standards.md), and the auditor-signature line sits inside that same
...
[E15](../corrections/corrections.md): that entry graded a claim too high by asking who wrote the source, this
...
[house language § 7](../authorities/house-style.md), which sets out what every frontier definition in force
actually measures.
...
*This row closes a queue item.* [E15](../corrections/corrections.md) listed "the AI Kill Switch Act's
...
[E20](../corrections/corrections.md) corrected this row's tally to two and named both, and this sentence —
...
[E13](../corrections/corrections.md), the quoted clause must be re-read by a human against the enrolled act
...
**Session:** 2026 · **Checked:** 21 Aug 2026 · ✅ **Primary now held on the source library, 26 Aug 2026** — the engrossed print, "SENATE BILL NO. 1297, As Amended, BY STATE AFFAIRS COMMITTEE," 3 pp., from the Idaho legislature's own site, which refused a machine on the same day. **Held, not yet read through.** · **Source:** engrossed/enrolled text, Idaho
Legislature
...
**Confidence. ✅ Read in full 25 August 2026** (superseding the ⚠ R grade this row carried until then, which read: "opened and searched directly, not read from a summary; not yet read by a human eye"). § 1421 was read entire from the enacted chapter text; see [PF-11](../revision/pre-review.md) for the four provisions SEC. 3(c)(4) adopts and never mentions. The original note continued: the enacted chapter text was opened and searched directly, not read from a
...
pinned verbatim in this project's own repository, which is the standard [E15](../corrections/corrections.md)
...
a negative finding from one fetch is the shape of [E11(c)](../corrections/corrections.md), where this project
...
corrected above from one to two. *Filed as [E20](../corrections/corrections.md).*
...
4. **The Assembly debate transcript** for the Comments. Assembly debate transcripts are held by
...
project has recorded — [E16](../corrections/corrections.md) above all — came from assembling a watch out of
...
- [x] **New York — S 1169-B** (Gonzalez) — *the New York AI Act.* Checked against the LegiScan
  ...
  **§ 110 is the most developed auditor-independence text in any American AI bill this project
  ...
  Its valve at § 110(4) is also its loophole, and the proportionality topic should look at it: an
  ...
  **§ 114(2) reverses the causation presumption at the pleading stage**, and then declines to let
  ...
  [known objections](../commentary/objections.md).
...
- [x] **Federal — S. 1792** — done, 23 Aug, ✅ **primary XML read in full** (public domain; held
  on [the source library](./verification-record.md)). The **AI Whistleblower Protection Act**
  ...
  [who has to tell you § 4b](./who-discloses.md).
...
- [ ] **Colorado — SB 26-189** — the transparency-only replacement after SB 24-205's repeal;
  ...
  [the enforcement record § 6](./state-enforcement.md).
- [ ] **Virginia — HB 797** — enacted IVO licensing via VITA (CDT). The Senate-side substitute,
  SB 384, is on [the source library](./verification-record.md) and is not the enacted vehicle.
...
- [ ] **Idaho and Tennessee — the AI-personhood-denial acts** (CDT) — statutes providing AI
  ...
  [known objections](../commentary/objections.md) at the surveyor's grade only.
- [x] **Federal — H.R. 8094** — done, night of 23–24 Aug, ✅ **primary read in full, all sixteen
  pages** (introduced print on [the source library](./verification-record.md)). The **AI
  ...
  **this Act's lineage-compute counting, in a bipartisan federal bill**, beside a
  ...
  [the definition](../commentary/what-frontier-means.md); the central finding stands — another federal
  ...
  **H.B. 720 (2022)** — not a 2026 act — Idaho Code § 5-346, operative sentence retrieved
  ...
  opened; [Amendment 19](../revision/proposals.md) carries the drafting consequence.

**Done 25 August, from the day's intake:**

- [x] **Federal — H.R. 9333** — done, 25 Aug, ✅ **primary read in full, all seven pages**
  (GPO introduced print on [the source library](./verification-record.md); the print's font
  ...
  **The row's find is the definition at § 2(e)(2)**, and it is the most useful sentence any
  ...
  [the reporting duty](./who-discloses.md) and at
  [Amendment 17/18](../revision/proposals.md).
...
- [x] **New York — the FOCUS Act** — done, 25 Aug, ✅ **primary read in full** (Fostering Optimal
  ...
  16298-02-6-1, dated 19 Aug, on [the source library](./verification-record.md); no bill number
...
mechanism and does not take it: nobody signs, and nobody answers.
  ...
  **What is not claimed.** Nothing here says the drafting is wrong. An ed tech registry is
  ...
  coverage at [the press corpus § 6](./press-corpus.md).
...
- **Federal** — H.R. 3460 · H.R. 5315 · H.R. 3434 · H.R. 8094 *(introduced text now on
  [the source library](./verification-record.md))* · ~~S. 1792~~ *(done 23 Aug, above)* · S. 1775, plus
  **H.R. 9925** *(the FRONTIER Act, tracked in [the standing watch](../revision/standing-watch.md)
...
for China; no House Comments per testimony); and the **CHIP Security Act** (House; chip location
...
[safe harbors, affirmative defenses, and the half-statute](../commentary/half-statutes.md).
...
(Aalok Mehta, CSIS, 24 Aug 2026; [press corpus](./press-corpus.md)).
...
is proportionate is the proportionality reviewer's question, and it is a fair one.
