...
SKIP_DIRS = {".git", "_site", "archive", "_sass", "_includes", "node_modules",
             "_to_delete", "_patches", "__pycache__", "_internal", "_retired", "archive"}
...
SKIP_FILES = {
  "./corrections/drafting-history.md",     # the drafting record: verbatim and unedited
  "./appendix/dossier.md",   # sealed
  # Repathed 26 August 2026 by the remap. ledger/{errata,diary,changelog}.md merged into
  # docs/record.md; dossier/README.md became evidence/dossier.md. The exclusions below moved
  # with them -- a merge that carries content across must carry its exemptions too, or a
  # normaliser silently edits sealed text the next time it runs.
  "./corrections/corrections.md",      # corrections + changelog + work log: quotes wrong words as specimens
  "./appendix/dossier.md", # sealed; quotes its sources verbatim
...
FOREIGN_QUOTES = {
 ...
 ("./corrections/changes.md", "Independent Verification **Organisation**"): "quotes the census's own error",
 ("./corrections/changes.md", "knowingly or **wilfully**"): "quotes the tagged text verbatim",
 ("./corrections/changes.md", "*wilful/willful* both ways"): "names both spellings on purpose",
 ("./corrections/drafting-history.md", None): "the frozen record records what the text said on the day",
 ("./appendix/dossier.md", None): "sealed dossier, quotes its sources verbatim",
 ("./corrections/corrections.md", None): "corrections register: quotes misspelled text as evidence",
 ("./appendix/dossier.md", None): "sealed dossier, quotes its sources verbatim",
}
...
OWN_BLOCKQUOTES = [
 ...
 ("./corrections/corrections.md", "may characterise another"),
