...
SKIP_DIRS = {".git", "_site", "node_modules", ".jekyll-cache",
             # _to_delete is a holding area, not repository content. Files are moved
             ...
             "_to_delete", "_patches", "_internal", "_retired", "archive"}
...
ALLOWED_UNLINKED = {
    "CLAUDE.local.md": "gitignored: the maintainer's personal layer beside the public CLAUDE.md. It is not repository content and nothing may link to it.",
