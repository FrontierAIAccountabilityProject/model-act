...
*Companion to [house language § 6](../authorities/house-style.md), which states the asymmetry in one
paragraph, and to [the bill census](../appendix/bill-census.md), which establishes that no American
...
§ 5](../authorities/house-style.md) says plainly that a named, owed, enforceable duty is the object and the
...
[house language](../authorities/house-style.md) demonstrated on a single individual.
...
[house language](../authorities/house-style.md) says to distrust. **This file does not adopt them.** What it
...
*Full entry, graded, at [the dossier](../appendix/dossier.md).*
...
*[House language](../authorities/house-style.md) argues that the words used about frontier AI distribute
...
weed" ([press corpus § 5](../appendix/press-corpus.md), ⚠ P). The metaphor section
...
[the census rubric](../appendix/bill-census.md#the-confidence-rubric-governed-by-e15) — opened, not
...
([who has to tell you § 4b](../appendix/who-discloses.md) carries the comparison) — and the federal
...
([enforcement record § 1](../appendix/state-enforcement.md)). Schmidt is here because
...
[already a crime, if you are a person](./already-a-crime.md).*
...
[the census](../appendix/bill-census.md#the-confidence-rubric-governed-by-e15).*
