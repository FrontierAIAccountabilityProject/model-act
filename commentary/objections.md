...
| "You cannot prove our model exceeded 10²⁶ operations." | Training figures are trade secrets; outside estimates can be wrong. | The figure is not proven by outside estimate: the developer certifies its own compute under SEC. 8, and lying in that certification is the offense. Self-designation (Amendment 6) and Agency designation are independent routes that need no figure at all. And administrability is now conceded from both ends of the politics — chip location-verification as live federal policy, the forecasters' declaration-and-audit engineering ([two visions](./two-visions.md)). |
| "The threshold is arbitrary." | A model just below may outperform one just above. | 10²⁶ is one objective trigger among several routes, updatable by rule under SEC. 3 — and Meta's own framework adopts the same figure as its top-tier criterion, which is difficult to call arbitrary while using it. The forecasters' caution that compute units blur over time ([forecast arithmetic § 6](../appendix/forecasts.md)) argues *for* the capability-designation routes riding beside the bright line — the Act's design already carries its critics' fix. |
| "*Dotterweich* and *Park* concern the Food, Drug, and Cosmetic Act." | The doctrine does not migrate automatically. | Agreed. The Act does not borrow liability; it enacts its own elements, and takes from the doctrine only the principle — duty follows the person standing in responsible relation to a public danger with power to prevent it. See [the case](./the-case.md). |
...
([press corpus](../appendix/press-corpus.md)). That is what SEC. 9's reporting
...
([press corpus § 5](../appendix/press-corpus.md); the fiscal use at
[the fiscal note](../enactment/fiscal-note.md)).
...
honestly at Decision 4, not here.
...
[the census](../appendix/bill-census.md#the-queue)). Two legislatures have already
...
[Amendment 16](../revision/proposals.md#amendment-16--sec-1b7-a-deception-limb-because-van-buren-excludes-what-actually-happened)
...
([the census](../appendix/bill-census.md) and
[the watch](../revision/standing-watch.md) own the facts). The survey literature's own
...
([why the disparity](./why-the-disparity.md)). The Act is risk-based in the only sense
...
[the reviewer page](../revision/worklist.md) exist because assistants reproduce known misreadings of this
...
page: [safe harbors, affirmative defenses, and the half-statute](./half-statutes.md).
...
declines nothing it could have had** ([E67](../corrections/corrections.md)). The date was also wrong here —
...
[Amendment 22](../revision/proposals.md) is the repair.
...
secondary sources' pincites and are not verified ([E47](../corrections/corrections.md)). ✅ ***Bank of New
England* was read on 26 August 2026** and this page's account of it has been corrected in two
respects ([E67](../corrections/corrections.md)); ⚠ its 856 pincite is still unverifiable, the copy carrying no
...
— see [E48](../corrections/corrections.md).
...
premise is a retrieval, not a finding** ([E57](../corrections/corrections.md)).
...
false certification, faces the felony penalties of SEC. 10(c). (The statute's own spelling of that word is not American; the point is [Amendment 22](../revision/proposals.md)'s, not this page's.)
...
*Kaiser Aetna*'s, as now quoted ([E70](../corrections/corrections.md)). ⚠ 150 remains the complaint's pincite:
...
[Amendment 23](../revision/proposals.md) restores publication on the terms of California Business
...
good on *Ruckelshaus* and on an extension nobody has briefed ([E70](../corrections/corrections.md)).
...
([E68](../corrections/corrections.md)).
...
[E60](../corrections/corrections.md).

⚠ **Pincite not confirmed.** The copy held carries slip pages, not Atlantic Reporter pages, so the
published *294 A.3d 65, 90, 92* remains unverified ([E47](../corrections/corrections.md)). The quotations are
...
this repository assumed from its filename ([E68](../corrections/corrections.md)). **The
*In re TransUnion* sentence removed by [E46](../corrections/corrections.md) stays removed** — it has not been
re-checked, and nothing in the *Walton* correction bears on it.
Under [E22](../corrections/corrections.md) nothing here may be described as verified, and no outreach may cite
...
(Courthouse News, 24 Aug 2026; [press corpus](../appendix/press-corpus.md)).
...
statute; see [the census](../appendix/bill-census.md) for why it is recorded as an
...
serious ([the forecasters' arithmetic](../appendix/forecasts.md), § 3).
...
([paths to enactment](../enactment/paths-to-enactment.md)): public-welfare statutes pass in the weeks
...
*The argument this page defends: [the case](./the-case.md). The definitions it defends:
[the definition](./what-frontier-means.md). The operative language under attack:
[the statute](../act/model-act.txt) and [the v3.5 queue](../revision/proposals.md).*
...
[the state enforcement record](../appendix/state-enforcement.md) § 7.
