...
page at [the statute translated](../enactment/plain-english.md), and the questions this project is
...
[the dossier](../appendix/dossier.md); the doctrine and drafting behind every provision are
in [the Comments](../act/comments.md) and [the record](../corrections/drafting-history.md).
...
[the dossier](../appendix/dossier.md#dossier--the-politicians-track-the-record-already-exists). A letter is not yet a subpoena — but the
...
[the comparative file § 5](./other-jurisdictions.md#5-the-united-states-today--the-codified-officer).
...
now true as written. [The register](../corrections/corrections.md) preserves both states, and the
announced cures ([the queue](../revision/proposals-adopted-v3-4.md)) entered the text verbatim.*

*As of v3.4, the five statements this section once made ahead of the text are true as
written; [the register](../corrections/corrections.md) records the interval, each entry beside its
...
**The Act in nine lines.** SEC. 1 classifies the offenses in the public-welfare topic that
...
[the dossier's question-and-answer chapter](../appendix/dossier.md#questions-and-answers).

**The section-by-section translation of the statute used to sit here.** It is now its own
document — [the statute, translated](../enactment/plain-english.md) — because it is reference rather
...
Comments. The application is regulated; the model beneath it is exempt in black letter,
...
news outlet's ([the press corpus](../appendix/press-corpus.md) § 7). And
...
signing the letter ([the enforcement record](../appendix/state-enforcement.md) § 7).
...
[the dossier](../appendix/dossier.md#dossier--the-politicians-track-the-record-already-exists).
