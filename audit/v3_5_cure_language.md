...
[REVIEWERS.md](../REVIEWERS.md); three lanes have their whole apparatus on one printable page each
at [the review packets](../packets/README.md). This file's working labels map to the state-of-play
