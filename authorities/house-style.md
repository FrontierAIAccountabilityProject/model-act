...
at [CURE 7](../revision/proposals.md) reaches a deployer only at consequential scale — mass
...
**Two — the diary.** [Part III of the ledger](../corrections/work-log.md) is a working log written by a
...
[the same conduct, prosecuted](../commentary/the-same-conduct.md).)* In July 2011 the
...
logs ([the incident record](../appendix/dossier.md)), which is what enforcement looks like when the conduct statute does not exist: chief law
...
|---|---|
| [California SB 53 · New York RAISE · Illinois](./adopted-standards.md) · [Connecticut SB 5](../appendix/bill-census.md) | training compute greater than **10²⁶ operations** |
| Connecticut's **large** frontier developer tier | the above, **plus \$500,000,000** in annual gross revenue |
| [**H.R. 9917**](../appendix/bill-census.md) (AI Kill Switch Act) | compute *"the cost of which would exceed **\$100,000,000** at the prevailing market price"* |
...
[CURE 7](../revision/proposals.md) would go further, reaching a deployer at consequential
...
authorities](./table-of-authorities.md)), and it was born on a frontier.
...
frontier-AI officer duty attracts today — and [the comparative provisions](../commentary/other-jurisdictions.md)
...
read one by one in the dossier](../appendix/dossier.md) —
...
rubric](../appendix/bill-census.md#the-confidence-rubric-governed-by-e15).*
...
Set that beside the finding in [the same conduct](../commentary/the-same-conduct.md): the executive who was
...
[SEC. 8](../enactment/plain-english.md) exists to fill. **Nobody signs the sentence either.**
...
- **And under 21 U.S.C. § 333(a)(1), the person who ships an adulterated article commits a federal
  ...
  are at [already a crime, if you are a person](../commentary/already-a-crime.md).*
...
[the press corpus](../appendix/press-corpus.md) and
[the AISI incident file](../appendix/incident-report.md). Grading at the end; the
...
events described by [a security vendor](../appendix/commentary-sweep.md): *"instructions described a boundary
...
**But [the glossary](./glossary.md) sets out why it matters anyway.** A model is not a
...
now quarantined at [E22](../corrections/corrections.md)). **Read every remaining ⚠ date as "probably a day
earlier than shown," and publish none of them as fact.** Filed as [E21](../corrections/corrections.md).
...
[the press corpus § 5](../appendix/press-corpus.md)).

*Machine intelligence* and *emergent* now carry entries of their own in
[the glossary](./glossary.md#the-words-that-carry-the-most-freight).
...
enacted law**, traced in [the census](../appendix/bill-census.md), and the naming is the part a
...
observation [why a signature works](../commentary/why-a-signature-works.md) makes about the published safety
...
This is [E22](../corrections/corrections.md#e22--a-quotation-held-in-a-working-summary-is-not-a-quotation) generalized, and the reasoning is recorded at
[E32](../corrections/corrections.md#e32--e22-extended-from-the-repository-to-correspondence). E22 was written about quotations: a quotation held in a working
...
[the errata register](../corrections/corrections.md) with the fix attached and permanent credit.*
