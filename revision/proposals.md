...
>
> An in-house pre-review across the five topics
> ([the internal review](./internal-review.md)) returned **seven findings graded fatal**, four in the
> tagged statute and three in drafting proposed here, and it identified required amendments to
> **Amendment 6 and Amendment 7 before either may land**. No entry in this file should be spliced into the
> statute until the corresponding sweep finding is resolved. In summary:
>
> - **Amendment 6 and Amendment 7** each carry a **⚠ AMENDMENTS REQUIRED** block inside the entry itself —
...
> - **A new Decision 4** records the jurisdictional finding, which is the most consequential
>   thing the internal review produced.
> - **Process rule adopted:** every entry in this queue must carry a one-line **administrative
>   load** note before adoption. Amendment 7 added two rulemakings and a securities-analyst coverage
>   inquiry without anyone in the fiscal topic being asked.
> - **CURES 8–16 are the internal review's own drafted responses**, filed 22 August 2026 and marked
>   **from the internal review, unchecked, not maintainer-drafted**. Every ANCHOR in them was verified verbatim against
...
> Act's jurisdictional reach (Decision 4). **On the internal review's findings, v3.5 is a rebuild rather
...
*Opened 21 August 2026 by [E16](../corrections/corrections.md). **Not a cure — a drafting decision**, held
here rather than made silently, because it changes the tagged statutory text and
[E10](../corrections/corrections.md) forbids editing a tagged file outside a revision.*
...
the Comments as the closest any legislature has come to the vacancy this Act fills — a statute
...
look for it, at [the adopted texts](../authorities/adopted-standards.md), so it reads as a decision
rather than a gap. The full row is at [the bill census](../appendix/bill-census.md).
...
information" (Politico, 21 Aug; The Next Web, 24 Aug — both at [the press corpus](../appendix/press-corpus.md)).
...
with Irregular named only in the reporting ([the dossier](../appendix/dossier.md) § A.4, corrected
...
*Opened 22 August 2026 by [the internal review](./internal-review.md), enforcement topic, graded **fatal**.
...
But SEC. 0 is uncodified findings — the Comments's PLACEMENT section says to enact it outside the
...
is exactly the extraterritoriality question Open issues item 5 reserves for a federalism litigator.
...
preservation letter, now read in full ([enforcement record § 3](../appendix/state-enforcement.md)),
...
or evaluation for potential serious incidents" ([standing watch § 8](./standing-watch.md))
...
conduct abroad, keyed to an intention, is exactly what Open issues item 5 reserves for a federalism
...
*Resolves Open issues item 3(b) (Comments): the harm tier's injury definition leaves
...
[the internal review](./internal-review.md) rejects the framing:** it assumes the reporting side is the safe
...
injury" or "serious physical injury" differently, and the Comments directs codification among the
...
**Still open:** Open issues 3(c), the bracketed [two]-year minimum. The sweep finds the *number*
...
[the state enforcement record](../appendix/state-enforcement.md) § 1) is a criminal
...
*Cures finding F4 (drafting record, [chunk 7](../corrections/drafting-history.md) §3.9; register ★★★, new
...
*The v3.4 cures landed in the statute and the Comments; three of them never cascaded into
`model_regulations_v1_draft.md`, which still describes itself as "conformed at v3.3 assembly."
A Comments instrument that contradicts the Act it implements is the defect the two-document
...
**Held open.** Part 2's version pins still await re-pin at adoption (Comments Open issues item 1);
...
*Closes Open issues item 11 (Comments), carried through v3.3 and uncured at v3.4:
...
**The precedent has since acquired an AI-native Comments — from the developers' own
...
[the press corpus](../appendix/press-corpus.md); the developer and forensic
...
**Operation 4 — restore *Park*'s burden structure.** The Comments at n.6 asserts that SEC. 6(d)
...
now stands on the opinion rather than on the Comments's summary of it.
...
undefined. The sweep drafted language for each; both need a criminal-law reviewer before they enter this
queue as operations.
...
SEC. 1–13 or the regulations. The Comments names the donor at n.26: 21 U.S.C. § 331(e). But
...
stack. For the evaluations researcher at Open issues item 6.
...
[which way each provision moves](../enactment/which-way-it-moves.md).
...
[who has to tell you](../appendix/who-discloses.md) identifies.
...
**⚠ AMENDMENTS REQUIRED BEFORE THIS Amendment LANDS — [internal review](./internal-review.md), open-source topic, graded fatal.**
...
Amendment reader; see [the internal review](./internal-review.md).**
...
**⚠ AMENDMENTS REQUIRED BEFORE THIS Amendment LANDS — [internal review](./internal-review.md), criminal-law, security, open-source and fiscal topics.**
...
list, so the illustrative set lives in [the research](../appendix/companies-covered.md) and the
...
class as Amendments 8–16, arising from the day's research sweep (the enacted-family texts now on the
shelf; the AISI reporter's public identification; the federal instruments read in full; sources at
[the verification record § 6](../appendix/verification-record.md)). Treat each as a hypothesis
about the fix.*
...
incident's ⟨PERSON_C⟩, publicly identified 20 August ([the incident file § 5](../appendix/incident-report.md))
...
([the gallery's escape section](../commentary/the-same-conduct.md#when-the-escaped-thing-was-the-crime)).
...
**adoption-gated on reading both acts**, queued at [the census](../appendix/bill-census.md#the-queue)).
...
act (P.A. 26-15) is held on [the source library](../appendix/verification-record.md). And the survey detail
...
addendum](../appendix/incident-report.md)). And a state has already treated a
...
([enforcement record § 6](../appendix/state-enforcement.md)). Deception-based
...
LLC v. Weiser*, the United States intervening; [enforcement record § 6](../appendix/state-enforcement.md)).
...
[the half-statute page](../commentary/half-statutes.md) documents. A hostile
...
([the affirmative frame](../commentary/half-statutes.md)); the register
...
*Ruled in 24 August 2026; enters the v3.5 Comments at the revision — held here until then so
...
[two visions](../commentary/two-visions.md) · [the forecasters' arithmetic](../appendix/forecasts.md).
...
of a legal requirement ([E66](../corrections/corrections.md)).
...
under 35 U.S.C. § 271(b) deciding no constitutional question ([E65](../corrections/corrections.md)). ⚠ CRS
...
first case, narrowed a general word into a specific statute. See [E48](../corrections/corrections.md). The
pincite 1026 is still the secondary source's: the text was read in a source carrying no star
pagination, so under [E47](../corrections/corrections.md) the page is unconfirmed.
...
pagination ([E47](../corrections/corrections.md)). Lyness, 64 B.C. L. Rev. 253, remains unread in the original.
...
felonies. That inverts the reasoning. See [E56](../corrections/corrections.md).
...
watch](./standing-watch.md) § 1). Publishing everything hands that count its best fact.
...
([E28](../corrections/corrections.md)) — is making a serious argument that this cure does not answer.
...
([E48](../corrections/corrections.md)).
...
constitutional defense of SEC. 6(a)'s entire design, and [known objections](../commentary/objections.md)
...
[known objections](../commentary/objections.md) does not make that connection.
...
reasonable inquiry."** [Known objections](../commentary/objections.md) reports that the Act "picks
...
[the open question](../commentary/objections.md) that section has been holding since August.
