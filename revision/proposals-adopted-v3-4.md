...
> [v3_5_cure_language.md](./proposals.md). These cures are adopted text — read this
...
## Amendment 1 — Deployer de-minimis and reliance rule
...
## Amendment 2 — Controlling person narrowed; express exclusions
...
## Amendment 3 — Provisional-validation rebuild; disclose-and-deploy becomes a report
...
## Amendment 5 — Direct and proximate causation
...
## Amendment 6 — Insurance ban made prospective; restitution carved out
...
## Amendment 7 — No-chief-executive fallback
...
## Amendment 8 — Agency-approval validation mode struck
...
## Amendment 9 — Interim lineage default; records duty decoupled at a lower audit floor
...
## Amendment 10 — "Material expansion" defined in statute; rule elaborates, never supplies
...
## Amendment 11 — Autonomous external-access capability: statutory description plus rule-hook
...
## Amendment 12 — Certification triggers defined; periodic batch cadence below the material line
...
## Amendment 13 — Records offense: privilege preserved, facts reachable
...
## Amendment 14 — Near-miss: contained-by-design is recorded, not reported
...
## Amendment 15 — Fallback recipient until the Agency exists
...
## Amendment 16 — Conduct-based controlled research
