...
| *United States v. Ahmad*, 101 F.3d 386 (5th Cir. 1996) | CURE 22; CURE 24; the criminal lane | ⚠ **Still not held, and the quotation is the CRS report's, not the reporter's.** At 391, **against this Act**: CWA discharges are not public welfare offenses because they are "felonies punishable by years in federal prison" (quoting *Staples*, 511 U.S. at 618). ✅ **The answer is now read and held.** *Weitzenhoff*, 35 F.3d at 1286 n.7 holds that *Staples* "refrains from holding that public welfare offenses may not be punished as felonies," and *Hanousek*, 176 F.3d at 1122 n.4 rejects the penalty argument by name: "this argument was rejected in *Weitzenhoff*." **What is left is a circuit split, not an unanswered objection** — and the Fifth Circuit's half descends from a five-judge dissent from rehearing en banc in *Weitzenhoff* itself, which is where a reviewer should read it at full strength |
...
| *Staples v. United States*, 511 U.S. 600 (1994) | **new row 26 Aug 2026**; CURE 22; CURE 24; the criminal lane | ⚠ **Unread in the primary, and it is the pivot of the whole felony question.** Both sides cite it. *Ahmad* at 391 quotes it at 618 against public-welfare treatment of felonies; *Weitzenhoff* at 1286 n.7 quotes its reservation — "[w]e need not adopt such a definitive rule of construction to decide this case" — for the opposite; *Hanousek* at 1121 cites it at 607 for what public welfare legislation is for. **Three of this table's rows rest on a case nobody here has opened.** Tier 1 retrieval |
...
| *Ruckelshaus v. Monsanto Co.*, 467 U.S. 986 (1984) | known objections; the takings lane | ✅ **TEXT READ IN THE OPINION 26 Aug 2026** (held in the working library). ⚠ **Pincite 1003–04 still unconfirmed**: the copy held carries no usable pagination — the 1007/1008/1009 figures in it are the dissent's internal cross-references, not page markers. **Holding, verbatim:** "a trade secret is property protected by the Fifth Amendment Taking Clause." **And the answer this project relies on, now verified from the opinion rather than from the plaintiff's brief** — and stated more strongly than we had paraphrased it: of the three *Penn Central* factors the Court directs attention to investment-backed expectations, "for we find that the force of this factor is **so overwhelming** … that it **disposes of** the taking question." Monsanto "could not have had a reasonable, investment-backed expectation that EPA would keep the data confidential **beyond the limits prescribed in the amended statute itself**," being "on notice of the manner in which EPA was authorized to use and disclose any data"; having chosen to submit in order to receive a registration, "**it can hardly argue** that its reasonable investment-backed expectations are disturbed." **The Act sits on the safe branch**: SEC. 3(c)(3) makes no lawful conduct retroactively unlawful, SEC. 1(b)(1) makes designation prospective only, and SEC. 12 disclaims retroactive liability — so the terms are stated before any duty attaches, which is the fact that defeated Monsanto |
...
| *SEC v. Jensen*, No. 14-55221 (9th Cir. 31 Aug 2016) | **not yet cited; retrieval lead 25 Aug 2026** | ⚠ **The appellate authority this project's "no-fault clawback" characterization rests on and does not cite.** Reported as the first court of appeals to decide whose misconduct triggers SOX § 304, holding the issuer's misconduct suffices though the officers themselves were innocent; district courts had split for fourteen years. **Known only from a law-firm alert; the opinion is unread and no words here may be attributed to the court** (E22, E48). **Disambiguation, recorded before it bites:** this is not the *Jensen* already in this repository — that is the DOJ food-safety prosecution in D. Colo. cited at n.22 and in the changelog for the restitution outcome. **Two cases, one surname, opposite subjects; never write "Jensen" unqualified again** |
