...
| *Staples v. United States*, 511 U.S. 600 (1994) | **row expanded 26 Aug 2026**; n.6; CURE 22; CURE 24; the criminal lane | ⚠ **Unread in the primary, and it is the pivot of the whole felony question.** ✅ **Two pincites now confirmed from *Ahmad*'s own citations, read in that opinion 26 Aug 2026**: **607** for "[t]ypically, our cases recognizing such offenses involve statutes that regulate potentially harmful or injurious items"; **618** for both "dispensing with mens rea would require the defendant to have knowledge only of traditionally lawful conduct" and "absent a clear statement from Congress that mens rea is not required." **Both sides of the felony question read the same opinion.** *Ahmad* takes 618 to exclude serious felonies from the exception; *Weitzenhoff* at 1286 n.7 quotes the Court's own reservation, "[w]e need not adopt such a definitive rule of construction to decide this case," for the opposite. **Nobody in this repository has opened it.** Tier 1 retrieval. ⚠ **This row was added on 26 Aug 2026 beside an existing *Staples* row under "Culpability and elements" that nobody checked for first** — see [E53](../ledger/errata.md) |
...
| *Ontario Provincial Council of Carpenters' Pension Trust Fund v. Walton* (Del.) | **new row 26 Aug 2026**; governance | ⚠ **NOT HELD, and this is the case [E46](../ledger/errata.md) found carrying two fabricated quotations.** Retrieval failed 26 Aug 2026 on a bot challenge. **courts.delaware.gov is reachable and a manual pull should work**; until it does, nothing may be attributed to this case |
