...
| *United States v. Hanousek*, 176 F.3d 1116 (9th Cir. 1999); cert. denied, 528 U.S. 1102 (2000) | the glossary; SEC. 6(a) | ⚠ At 1120–21: ordinary negligence suffices under 33 U.S.C. § 1319(c)(1)(A). Thomas, J., dissenting from denial: the CWA reaches "persons using standard equipment to engage in a broad range of ordinary industrial and commercial activities." **This authority cuts both ways and until 25 Aug 2026 this repository carried only one edge.** The holding that ordinary negligence suffices is the objection *against* SEC. 6(a) — and it is simultaneously the appellate confirmation that **the federal negligence-plus-responsible-officer misdemeanor exists and has been upheld**, which is SEC. 6(a)'s best precedent. Still unread in the reporter |
