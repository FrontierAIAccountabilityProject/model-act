...
<sub>📁 **dossier** · ← [repo home](../README.md) · new here? the plain-language version is in [`/docs`](../docs/) · the bill itself → [`model_act_v3_3.txt`](../model_act_v3_3.txt)</sub>
...
<sub>📁 [dossier home](./00_README.md) · ← [incidents](02_incident_timeline.md) · next → [wealth & control](04_wealth_and_control.md)</sub>
...
<sub>📁 [dossier home](./00_README.md) · ← [politicians](03_politicians_track.md) · next → [Q&A](05_questions_and_answers.md)</sub>
...
<sub>📁 [dossier home](./00_README.md) · ← [Q&A](05_questions_and_answers.md) · end of dossier · back to [repo home](../README.md)</sub>
