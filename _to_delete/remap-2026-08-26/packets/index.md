...
**Alongside every packet.** [The glossary](../standards/what_these_words_mean.md) defines the words
the Act turns on. [Known objections](../docs/known_objections.md) carries the attacks already made
and the answers given. [For reviewers](../REVIEWERS.md) is the seat itself: the ask, the hours, and
every open item in one line each.
