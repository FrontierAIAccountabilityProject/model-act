---
title: Proposals for v3.5
nav_order: 3
---

# Proposals for the next revision

*Everything proposed for the next revision, and every question still open, on one page.*

*The summary tables come first; the full text of each proposal follows below.*

**Verification is not asked of you.** Read the Act, then read the proposals below. Each states the
current text, the proposed replacement, and the reason for it. State whether it is correct.
Supporting citations are collected in [Reference](./reference.md) and prior corrections in
[Record](./record.md); neither is required reading, and a review that does not open them is
complete.
...
| 5 | 8 | Punctuation only | Nothing. Adopt it. |
...
*Opened 21 August 2026 by [E16](./record.md). **Not a cure — a drafting decision**, held
here rather than made silently, because it changes the tagged statutory text and
[E10](./record.md) forbids editing a tagged file outside a revision.*
...
look for it, at [the adopted texts](./reference.md), so it reads as a decision
...
information" (Politico, 21 Aug; The Next Web, 24 Aug — both at [the press corpus](../evidence/press_corpus_july_august_2026.md)).
...
model. Two sub-questions for the security and criminal-law reviewers: (a) does SEC. 2's duty, or
...
legitimate red-team and a risk-generating deployment. That is a security-reviewer and
criminal-law-reviewer question, not a solo drafting call.
...
reviewer: is the "practical authority to halt" standard already broad enough to reach the officer who
...
is a genuine gap is exactly the provability/architecture judgment the enforcement reviewer exists to
make.
...
*Opened 22 August 2026 by [the internal review](./internal_review.md), enforcement topic, graded **fatal**.
...
**The proposed amendment**, which the internal review calls the highest-value change it produced. Amend
...
is exactly the extraterritoriality question open issue 5 reserves for a federalism litigator.
**It also disposes of Decision 2** — the safeguards-disabled evaluation — on the enforcement
side, and is a precondition to any useful answer to Decision 3.
...
preservation letter, now read in full ([enforcement record § 3](../evidence/state_enforcement_record_2026.md)),
...
*A ruling, not a finding, and it is recorded as one. It follows the precedent of Amendment 19's wording
and Amendment 23's restoration: the maintainer decides, says so, and writes underneath what a reviewer could
...
conduct abroad, keyed to an intention, is exactly what open issue 5 reserves for a federalism
...
federalism reviewer, on the reasoning this entry already gives.

**What a reviewer may still overturn, and should be told it may.** That limb (i) is jurisdictionally
...
**Status: half landed by ruling, half open. Limb (ii) is for the federalism topic. The single most
...
*Resolves open issue 3(b) (companion): the harm tier's injury definition leaves
...
**Held open — one design note, now answered by the internal review: NO.** The question was whether the
SEC. 9 *reporting* trigger should keep broader language (report widely on the (h)(4) base; convict
precisely on (h)(3)) while the SEC. 10(c) *element* takes (h)(3) alone. **The criminal-law topic of
[the internal review](./internal_review.md) rejects the framing:** it assumes the reporting side is the safe
...
**One further amendment the internal review requires.** Most state penal codes already define "serious bodily
...
**Still open:** READ FIRST 3(c), the bracketed [two]-year minimum. The internal review finds the *number*
...
priority rule. Both need a criminal-law reviewer.
...
*Found outside the topics, reading the definitions in order. Filed here rather than as a new open
...
**The residue, stated so it is not mistaken for accident.** Three things stay true after Amendment 1
lands. (1) Acute, non-protracted psychological harm without substantial risk of death remains
outside "serious bodily injury" — and the internal review's own ruling in this entry (use (h)(3) for both;
...
[the state enforcement record](../evidence/state_enforcement_record_2026.md) § 1) is a criminal
investigation built on chat logs. Evidentiary, for the criminal-law topic; no drafted response.
(3) Even fully cured, every report runs to the Agency and SEC. 9(c) keeps it unpublished; no duty
anywhere in the Act tells an injured **person** anything. Amendment 14's notice duty runs to persons
whose *systems* were accessed, not persons *injured*. Whether an injured-person notice belongs in a
public-welfare statute — or belongs to tort, discovery, and the enforcement record's FDUTPA topic —
...
operative text, records what Amendment 1 already resolves, and holds one question open.

## Amendment 2 — SEC. 13(c): a review valve on the suspension order

*Cures finding F4 (drafting record, [chunk 7](./history.md#chunk-7--the-hostile-brief-v33-read-by-the-other-sides-counsel) §3.9; register ★★★, new
...
lie against an order that suspends *too little* belongs to the enforcement reviewer, and is not
drafted here.
...
**Held open.** Part 2's version pins still await re-pin at adoption (companion open issue 1);
...
*Closes open issue 11 (companion), carried through v3.3 and uncured at v3.4:
...
anthropomorphism audit of 20 August 2026 — a term-by-term internal review of `model_act_v3_4.txt`
...
[the press corpus](../evidence/press_corpus_july_august_2026.md); the developer and forensic
...
*Opened 22 August 2026 by [the internal review](./internal_review.md), criminal-law topic, from findings
...
among the elements the State must prove. The internal review's finding that SEC. 6(d) deletes it stands, and
...
undefined. The internal review drafted language for each; both need a criminal-law reviewer before they enter this
queue as operations.
...
*Opened 22 August 2026 by [the internal review](./internal_review.md), enforcement topic, graded
...
*Opened 22 August 2026 by [the internal review](./internal_review.md), criminal-law topic. Sweep-derived.*
...
*Opened 22 August 2026 by [the internal review](./internal_review.md), criminal-law topic, graded
**fatal**. Sweep-derived.*
...
*Opened 22 August 2026 by [the internal review](./internal_review.md), open-source topic, graded
**fatal**. Sweep-derived.*
...
lineage and carries developer duties including the SEC. 2(a) modifiability budget. The internal review puts
...
stack. For the evaluations researcher at open issue 6.
...
*Opened 22 August 2026 by [the internal review](./internal_review.md), enforcement topic. Sweep-derived.*
...
**Added 25 August 2026 — this cure and [Amendment 15](#amendment-15--sec-3c2-a-disclose-and-fix-valve-because-the-text-currently-punishes-candor)
are the same defect facing opposite ways, and neither said so.** Amendment 15 repairs a text in which
...
[which way each provision moves](./which_way_it_moves.md).
...
*Closes correction E13. Mechanical correction only; no substantive change.*
...
*Opened 22 August 2026 from the frontier-models research ([research/frontier_models.md](../evidence/frontier_models.md)) and the self-designation findings. **A scope extension with adopt-ready text**, keyed to v3.4 with an exact splice; the capability-parity sub-question within it is held for the enforcement and security reviewers. Per [E10](./record.md), the tagged v3.4 text is not edited; this is proposed language for v3.5. Not legal advice; nothing here is described as ready for introduction.*
...
**⚠ AMENDMENTS REQUIRED BEFORE THIS Amendments LANDS — [internal review](./internal_review.md), open-source topic, graded fatal.**
...
Amendment reader; see [the internal review](./internal_review.md).**
...
*Sequencing ruling (24 Aug 2026, maintainer): **held for the enforcement and security reviewers** —
...
([research/frontier_enterprises.md](../evidence/frontier_enterprises.md);
[docs/the_definition.md](./the_definition.md)). **A scope-architecture extension with
adopt-ready text**, keyed to v3.4 with exact splices. Per [E10](./record.md), the tagged
...
vendor, not to any developer ([Open Question 3](#decision-3--sec-4-the-third-party-evaluator--does-practical-authority-still-run-to-the-officer)).
...
**⚠ AMENDMENTS REQUIRED BEFORE THIS Amendments LANDS — [internal review](./internal_review.md), criminal-law, security, open-source and fiscal topics.**
...
figure at all, so no bracket can cure it. Use Amendment 4 Operation 2's pattern: *"at a scale prescribed
...
**Administrative load: high, and the fiscal topic's objection is that this cure should probably wait.**
...
topic recommends sequencing the enterprise category to v4, for a state with a functioning agency,
...
list, so the illustrative set lives in [the research](../evidence/frontier_enterprises.md) and the
...
Amendment 4 Operation 2 used — the Act does not sprawl into a second regulatory field, which is what its
...
developer of a model it did not train — Amendment 6's carve-out stands. SEC. 2(b)'s closing sentence
...
criminal-law-topic question, flagged, not drafted.
...
of the (12)(iv) revenue alternative with Decision 1's Connecticut tier. And the capability
question of Amendment 6 remains where Amendment 6 left it: for the enforcement and security reviewers.

---

## Intake of 23 August 2026, evening — three new entries and five addenda

*Every item below is **from intake, unchecked, AI-drafted, not maintainer-validated** — the same honesty
class as Amendments 8–16, arising from the day's research internal review (the enacted-family texts now on the
shelf; the AISI reporter's public identification; the federal instruments read in full; sources at
[the verification record § 6](../evidence/verification_record.md)). Treat each as a hypothesis
about the fix.*
...
incident's ⟨PERSON_C⟩, publicly identified 20 August ([the incident file § 5](../evidence/aisi_incident_inc_2026_07_28_01.md))
...
**To Decision 1 (Connecticut).** The decision is now makeable on primary text: the chaptered
act (P.A. 26-15) is held on [the source library](../evidence/verification_record.md). And the survey detail
...
**To Decision 3 (the third-party evaluator).** The question is narrowing from both sides.
...
lead auditor (P.A. 104-0538, on the source library); Virginia licenses verification organizations through
VITA; Connecticut pilots the same. From the officer's: Decision 4's drafted amendment already
...
**To Amendment 4 (the recast triggers).** Two upgrades. The defeat-device precedent now carries its
...
**To Amendment 6 (self-designation; the flagged First Amendment amendment).** The doctrinal map is now
...
of fact, SEC. 9(c)'s no-characterization rule, with Amendment 4 removing the last
...
**To Amendment 15 (disclose-and-fix).** A federal echo: S. 1792's § 2(2)(B) (primary text in hand)
...
*Each item below touches a finding the internal review graded fatal, or a cure answering one. Same class:
from intake, unchecked, not maintainer-validated.*

**To Amendment 8 (SEC. 6(a) reconstructed) — the reconstruction matches the doctrine the state courts
...
actual violation, facilitation-by-failure. The internal review's hypothesis, drafted from *Park* alone,
independently converged on the formulation thirty years of state case law settled on — which is
evidence the fix is sound, and a citation for the criminal-law reviewer to check it against.
...
(Wash. Ct. App. 2013)). One further reference for the reviewer: Ferzan, *Probing the Depths of the
...
Amendment 10's four interim controls: (i) authentication ↔ approved-access and unique credentials;
...
elements Amendment 10 does not: personnel suitability (pre-access and ongoing), and the immediate-
report-to-a-named-person duty. The security reviewer's question — are the four the right four — now
has a federal answer sheet; whether elements five and six belong is exactly the reviewer's call.

**To Amendment 7, Operation 3 (advance designation) — the named person exists in federal regulation.**
...
**To Amendment 16 (the deception limb) — the record now speaks in the first person.** The member of
...
addendum](../evidence/aisi_incident_inc_2026_07_28_01.md)). And a state has already treated a
...
([enforcement record § 6](../evidence/state_enforcement_record_2026.md)). Deception-based
unauthorization is not a novel theory; it is being enforced.

**To Amendment 16, a second documented class — 24 August.** The limb no longer rests on one incident.
...
distillation farms — it is a pattern. The criminal-law reviewer's question is unchanged; its
evidentiary base is not.

**To Decision 4 — the Colorado caution supports the tier placement.** Colorado's duty-of-care
statute was repealed before effect under combined industry and federal litigation pressure (*xAI
LLC v. Weiser*, the United States intervening; [enforcement record § 6](../evidence/state_enforcement_record_2026.md)).
...
**To Amendment 19 (the personhood finding) — the gate, mostly discharged.** Primary and near-primary
...
([the pre-review pass](./internal_review.md)); language transplanted verbatim.
...
[the half-statute page](./safe_harbors_and_affirmative_defenses.md) documents. A hostile
...
([the affirmative frame](./safe_harbors_and_affirmative_defenses.md)); the register
...
[two visions](./two_visions.md) · [the forecasters' arithmetic](../evidence/forecast_arithmetic.md).
...
[the diary](../ledger/diary.md). Treat this entry as internal review-grade, not maintainer-drafted.*
...
that carries the sentence the Act exists to make available. Amendment 8's own *Held open* paragraph
...
of a legal requirement ([E66](./record.md)).
...
under 35 U.S.C. § 271(b) deciding no constitutional question ([E65](./record.md)). ⚠ CRS
...
to it is an amendment with a number, not an internal review — so the commentary around it was normalized to
...
first case, narrowed a general word into a specific statute. See [E48](./record.md). The
pincite 1026 is still the secondary source's: the text was read in a source carrying no star
pagination, so under [E47](./record.md) the page is unconfirmed.
...
paragraph says something the criminal topic has been arguing around all day: **the Ninth Circuit
...
pagination ([E47](./record.md)). Lyness, 64 B.C. L. Rev. 253, remains unread in the original.
...
to what [Amendment 8](#amendment-8--sec-6-the-individual-liability-offense-reconstructed) reconstructs SEC. 6
...
felonies. That inverts the reasoning. See [E56](./record.md).
...
about sewage plant operators, in 1994.** Whoever takes the criminal-law reviewer should be handed that
paragraph rather than *Ahmad*'s summary of it. **What the reviewer's question now is:** not "can a felony
...
*Opened 25 August 2026 by **maintainer decision**, not by a topic finding and not by the internal review. It
...
The incident report is filed. The certification's facts are on a public register (Amendment 21) and its
...
pretend the problem is elsewhere. **The torts and design reviewer and the enforcement reviewer both touch
...
([E28](./record.md)) — is making a serious argument that this cure does not answer.
...
*Opened 25 August 2026 from [PF-7](./internal_review.md), on reading 18 U.S.C. § 1350 and
...
**One. There is a circuit split on the question the criminal topic calls unanswerable, and this
...
view rather than producing it. **The internal review records *Ahmad* as the sharpest attack available and
says nobody in-house can settle it.**

**A court has settled it, and the case was already on the source library.** ✅ *Weitzenhoff* read in the
...
**The honest limit, and it is the reason this stays a topic question.** *Weitzenhoff* is a Ninth
...
constitutional defense of SEC. 6(a)'s entire design, and [known objections](./known_objections.md)
...
*Opened 25 August 2026 from [PF-8](./internal_review.md), on reading 21 U.S.C. §§ 332 and
...
**And it touches the takings topic.** A remedy operating on the thing rather than on conduct sits
closer to *Cedar Point*'s per se limb than to *Penn Central*'s regulatory one, and
[known objections](./known_objections.md) does not make that connection.
...
*Opened 25 August 2026 from [PF-9](./internal_review.md), [PF-10](./internal_review.md)
and [PF-11](./internal_review.md). Numbered 26 August 2026. **Until 25 August, two of the
...
different obligors changes what a certification means, and it belongs to the enforcement reviewer.

**And § 1421(4)(b)'s good-faith-and-reasonableness defense sits directly beside SEC. 8's "after
reasonable inquiry."** [Known objections](./known_objections.md) reports that the Act "picks
...
[the open question](./known_objections.md) that section has been holding since August.
