...
*Every objection made to this Act, and the answer given. Where there is no answer yet, the entry
says so.*

**Contents** — [The objections and the answers](#the-objections-and-the-answers) · [Questions asked most often](#questions-asked-most-often)
...
| "You cannot prove our model exceeded 10²⁶ operations." | Training figures are trade secrets; outside estimates can be wrong. | The figure is not proven by outside estimate: the developer certifies its own compute under SEC. 8, and lying in that certification is the offense. Self-designation (Amendment 6) and Agency designation are independent routes that need no figure at all. And administrability is now conceded from both ends of the politics — chip location-verification as live federal policy, the forecasters' declaration-and-audit engineering ([two visions](../_to_delete/remap-2026-08-26/docs/two_visions.md)). |
| "The threshold is arbitrary." | A model just below may outperform one just above. | 10²⁶ is one objective trigger among several routes, updatable by rule under SEC. 3 — and Meta's own framework adopts the same figure as its top-tier criterion, which is difficult to call arbitrary while using it. The forecasters' caution that compute units blur over time ([forecast arithmetic § 6](../evidence/forecast_arithmetic.md)) argues *for* the capability-designation routes riding beside the bright line — the Act's design already carries its critics' fix. |
| "*Dotterweich* and *Park* concern the Food, Drug, and Cosmetic Act." | The doctrine does not migrate automatically. | Agreed. The Act does not borrow liability; it enacts its own elements, and takes from the doctrine only the principle — duty follows the person standing in responsible relation to a public danger with power to prevent it. See [the case](../_to_delete/remap-2026-08-26/docs/the_case.md). |
...
([press corpus](../evidence/press_corpus_july_august_2026.md)). That is what SEC. 9's reporting
...
in SEC. 4(c)'s non-shield list (Amendment 7, Operation 4): *an audit is a control on power, not a substitute for identifying who holds the
...
reachable. Amendment 7 Operation 3 makes the anchor mechanical: one primary responsible officer
...
review is Ball (FAI, May 2026, before his OpenAI role): *"a machine-enabled future means
...
([press corpus § 5](../evidence/press_corpus_july_august_2026.md); the fiscal use at
[the fiscal note](../evidence/fiscal_note.md)).
...
[the census](../evidence/frontier_bill_census.md#the-queue)). Two legislatures have already
...
[Amendment 16](../_to_delete/remap-2026-08-26/docs/proposals.md#cure-16--sec-1b7-a-deception-limb-because-van-buren-excludes-what-actually-happened)
...
([the census](../evidence/frontier_bill_census.md) and
[the watch](../_to_delete/remap-2026-08-26/docs/proposals.md) own the facts). The survey literature's own
...
([why the disparity](../evidence/why_the_disparity.md)). The Act is risk-based in the only sense
...
A practical note for a reviewer working with an assistant: the per-topic errata on
[the reviewer page](../_to_delete/remap-2026-08-26/docs/worklist.md) exist because assistants reproduce known misreadings of this
draft. Check the generated objection against this page and against your topic's errata row before
...
page: [safe harbors, affirmative defenses, and the half-statute](../_to_delete/remap-2026-08-26/docs/safe_harbors_and_affirmative_defenses.md).
...
page leans on her further than those findings support should say so, and the review would be
published.
...
declines nothing it could have had** ([E67](../_to_delete/remap-2026-08-26/docs/record.md)). The date was also wrong here —
...
has a problem the drafting cannot argue its way out of, and the criminal-law reviewer should say so.**
...
circumstantial proof of knowledge." **Amendment 8's proposed burden-shift at SEC. 6(d) is exactly the
move that case forbids at the felony tier**, and
[Amendment 22](../_to_delete/remap-2026-08-26/docs/proposals.md) is the repair.
...
secondary sources' pincites and are not verified ([E47](../_to_delete/remap-2026-08-26/docs/record.md)). ✅ ***Bank of New
England* was read on 26 August 2026** and this page's account of it has been corrected in two
respects ([E67](../_to_delete/remap-2026-08-26/docs/record.md)); ⚠ its 856 pincite is still unverifiable, the copy carrying no
...
— see [E48](../_to_delete/remap-2026-08-26/docs/record.md).
...
**Held for the criminal-law reviewer**, and it belongs near the top of that reviewer's list, because it
...
defense with the burden on the defendant, is doing the most useful thing available in this topic.
...
premise is a retrieval, not a finding** ([E57](../_to_delete/remap-2026-08-26/docs/record.md)).
...
⚠ **Open, and it is the torts-and-design reviewer's question.** Whether SEC. 6(a) should carry a
...
on the source library. **She was written to during outreach and never replied**, which makes the absence
...
false certification, faces the felony penalties of SEC. 10(c). (The statute's own spelling of that word is not American; the point is [Amendment 22](../_to_delete/remap-2026-08-26/docs/proposals.md)'s, not this page's.)
...
*Kaiser Aetna*'s, as now quoted ([E70](../_to_delete/remap-2026-08-26/docs/record.md)). ⚠ 150 remains the complaint's pincite:
...
[Amendment 23](../_to_delete/remap-2026-08-26/docs/proposals.md) restores publication on the terms of California Business
...
good on *Ruckelshaus* and on an extension nobody has briefed ([E70](../_to_delete/remap-2026-08-26/docs/record.md)).

**Three.** The redaction power in SB 53 § (f) is exercised by the developer, with no agency approval
and no penalty attaching to over-redaction as such. If it is a rule in name only, Amendment 23 imports a
rule in name only.
...
([E68](../_to_delete/remap-2026-08-26/docs/record.md)).
...
[E60](../_to_delete/remap-2026-08-26/docs/record.md).

⚠ **Pincite not confirmed.** The copy held carries slip pages, not Atlantic Reporter pages, so the
published *294 A.3d 65, 90, 92* remains unverified ([E47](../_to_delete/remap-2026-08-26/docs/record.md)). The quotations are
...
design topic's sixth question and this project's largest unanswered one. It does not answer whether
...
deciding it.** If a governance reviewer can, that is a finding.
...
this repository assumed from its filename ([E68](../_to_delete/remap-2026-08-26/docs/record.md)). **The
*In re TransUnion* sentence removed by [E46](../_to_delete/remap-2026-08-26/docs/record.md) stays removed** — it has not been
re-checked, and nothing in the *Walton* correction bears on it.
Under [E22](../_to_delete/remap-2026-08-26/docs/record.md) nothing here may be described as verified, and no outreach may cite
...
(Courthouse News, 24 Aug 2026; [press corpus](../evidence/press_corpus_july_august_2026.md)).
...
were met is decorative, which is why the enforcement and security topics are asked whether these
...
bill can reach for a tool this Act cannot, and the proportionality and criminal topics should be
...
statute; see [the census](../evidence/frontier_bill_census.md) for why it is recorded as an
...
serious ([the forecasters' arithmetic](../evidence/forecast_arithmetic.md), § 3).
...
([paths to enactment](../_to_delete/remap-2026-08-26/docs/paths_to_enactment.md)): public-welfare statutes pass in the weeks
...
say in a review which leg fails: the window pattern, the arithmetic, or the asymmetry.

*The argument this page defends: [the case](../_to_delete/remap-2026-08-26/docs/the_case.md). The definitions it defends:
[the definition](../_to_delete/remap-2026-08-26/docs/the_definition.md). The operative language under attack:
[the statute](../model_act_v3_4.txt) and [the v3.5 queue](../_to_delete/remap-2026-08-26/docs/proposals.md).*
...
the paper should say so, and the review would be published.
...
[the state enforcement record](../evidence/state_enforcement_record_2026.md) § 7.
...
*The questions put to this project, with the answers it can defend and the ones it cannot.
Split from the front page on 21 August 2026. The argument behind these answers is
[the case](../_to_delete/remap-2026-08-26/docs/the_case.md).*
...
at [Amendment 7](../_to_delete/remap-2026-08-26/docs/proposals.md) reaches a deployer only at consequential scale — mass
...
maximal case against this text is [the hostile brief](../_to_delete/remap-2026-08-26/docs/proposals.md#chunk-7--the-hostile-brief-v33-read-by-the-other-sides-counsel).
...
any covered system — and SEC. 3(a) closes the standards topic to safety, authorization,
...
identified natural persons. ([Comparative source note](../evidence/comparative_officer_liability.md#1-china).)
...
([The provisions, including the sugar beets](../evidence/comparative_officer_liability.md#3-the-united-states-1879-to-1892).)
...
([The provisions](../evidence/comparative_officer_liability.md#2-germany).)
...
register](../_to_delete/remap-2026-08-26/docs/record.md).
...
([the adopted texts](../_to_delete/remap-2026-08-26/docs/reference.md)) — but the regulations draft referenced one paywalled
...
conflicts, a provenance page, and any completed expert reviews. Legislative
...
the [two]-year minimum, held open for the criminal-law reviewer.
...
discretion stays where state law puts it. Whether negotiated reviews should be
cabined for individual liability — the settlement culture is much of why entity-level
enforcement stopped deterring — is open, and belongs to the enforcement reviewer.
...
survives a real charging memo is [the enforcement reviewer's](../_to_delete/remap-2026-08-26/docs/worklist.md#enforcement-and-prosecution)
core question — open, and the reviewer exists because it is.
...
the full map is [chunk 2](../_to_delete/remap-2026-08-26/docs/proposals.md#chunk-2--preemption-armour-for-v33).
...
**Added 23 August 2026, for a First Amendment reader.** The self-designation route (Amendment 6)
...
SEC. 9(c)'s no-characterization rule; and Amendment 4, which removes the statute's last
...
[the field notes](../_to_delete/remap-2026-08-26/docs/proposals.md#field-notes-for-assembly--chunk-6-inputs) — the leash, the gun analogy, the
...
[the register](../_to_delete/remap-2026-08-26/docs/record.md). Criticism is raw material here; send more.


---

*Corrections to the project contact; they enter [the corrections](../_to_delete/remap-2026-08-26/docs/record.md) with the fix attached and permanent credit.*
