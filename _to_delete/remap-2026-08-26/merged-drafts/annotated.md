---
title: The Act, section by section
nav_order: 4
---

# The Act, section by section

*The notes on each section of the model act: what it does, why it is drafted that way, and what is
still open. In US drafting practice this is the section-by-section analysis; model-act publishers
call it the Comments.*

*The statutory text itself is [`the-act.txt`](../the-act.txt) — clean, with nothing but the Act, so
it can be pasted into a bill.*

---

The Act itself — SEC. 0 through SEC. 13 — is [`the-act.txt`](../the-act.txt). These are the notes
on it: what each section is for, why it is drafted as it is, and what is still open. Proposed
changes for the next revision are in [Proposals](./proposals.md).

---

<a id="read-first--open-items-for-the-next-revision-v35"></a>

## Open issues for the next revision
...
these notes on savings-clause construction. The counterweight is stated honestly: *Arizona v. United
...
tolling that runs from discovery) and the these notes regulations broke it a third way (Part 10.1's
