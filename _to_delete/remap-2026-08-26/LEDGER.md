...
Every published claim this project got wrong, with what was said, what was true, how it was caught
and the fix. Append-only; superseded wording is preserved beside its correction.

<a id="part-ii"></a>
## Part II — The changelog

→ **[`ledger/changelog.md`](./ledger/changelog.md)**

What changed in the statutory text and when, with the sha256 checksums that make each tagged
edition reproducible.

<a id="part-iii"></a>
## Part III — The diary

→ **[`ledger/diary.md`](./ledger/diary.md)**

The working account, day by day: what was read, what was found, what was refused, what is owed.
