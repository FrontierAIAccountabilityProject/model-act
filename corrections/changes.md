...
[errata register](./corrections.md) and [diary](./work-log.md) are beside it.*
...
[E42](./corrections.md#e42--the-doctrine-was-said-never-to-have-left-food-and-drug-it-left-decades-ago-by-act-of-congress).
...
*Where it landed.* [The sweep](../revision/internal-review.md) gains the gap in its enforcement
...
[The table of authorities](../authorities/table-of-authorities.md) carries the case as a candidate,
...
officer**, and [the enforcement record](../appendix/state-enforcement.md) § 7 says so in
...
[The case](../commentary/the-case.md) said in two places that a letter is not yet a subpoena. Both were
...
[Known objections](../commentary/objections.md) gains Marshall's own words under the patchwork
...
*The page.* [The project in one page](../enactment/summary.md). The problem in two sentences; what the
...
[who has to tell you](../appendix/who-discloses.md) § 4d with its limits attached — sworn
...
objections](../commentary/objections.md) gains the section, including the concession Kratsios made
...
**[E40](./corrections.md#e40--the-council-was-described-as-five-seats-after-it-had-grown-to-eight)** —
...
**[E41](./corrections.md#e41--three-packets-linked-to-a-path-the-projects-own-checker-already-knew-was-dead)**
...
[the dated record](../enactment/record-dated.md).
...
*Where it landed.* [Known objections](../commentary/objections.md) gains three sections: the
...
[Who has to tell you](../appendix/who-discloses.md) gains § 4c: Congress has already
...
[The table of authorities](../authorities/table-of-authorities.md) gains both hearings, and
...
**[E38](./corrections.md#e38--the-packet-that-promised-the-whole-lane-and-left-out-the-only-published-criticism-of-it)**
...
**[E39](./corrections.md#e39--the-same-sentence-twice-in-two-packets-for-a-day)** — the filing
...
[the register](./corrections.md), never copies); the state-of-play table moved ahead of the filing
...
section landed ([the same conduct](../commentary/the-same-conduct.md)) with the front page carrying
...
[the comparative file § 5](../commentary/other-jurisdictions.md). The queue took three
...
[the verification record § 6](../appendix/verification-record.md).

**Between versions — 22 August 2026, the enterprise pass.** Still no change to the tagged statute.
The scope architecture arrived in the apparatus: [CURE 7](../revision/proposals.md) drafts
...
[research/frontier_enterprises.md](../appendix/companies-covered.md) (the twelve-company
coverage set, four layers, verbatim self-designations, ownership and control from public filings);
the public face as [docs/the_definition.md](../commentary/what-frontier-means.md) (the two definitions,
technical beside legal) and [docs/known_objections.md](../commentary/objections.md) (the strongest
...
stands). Companion and apparatus only: the [v3.5 queue](../revision/proposals.md) settled
...
third-party-evaluator gap); the [glossary](../authorities/glossary.md) gained a
legal/technical two-column view and a definition of *accountability*; the
[table of authorities](../authorities/table-of-authorities.md) added *Moffatt v. Air Canada* and
Desai & Riedl as candidate authorities not yet cited; and the front-page contribution ask was recast
as three labeled doors; and, later the same day, the [frontier-models reference](../appendix/models-and-compute.md)
...
[CURE 6](../revision/proposals.md) proposed a third route into SEC. 1(b)(1) scope — a model its
...
**Errata opened.** [E16](./corrections.md) — a coverage failure; the standing watch missed Connecticut
SB 5, enacted twelve weeks earlier, and H.R. 9917, introduced four weeks earlier. Closed the same
day, with a correction to its own prescribed cure. [E17](./corrections.md) — an overstated disanalogy
...
[the drafting record](./drafting-history.md) already uses for its chunk heads — the checksum was taken
...
[the reporting page](../appendix/who-discloses.md), which now brackets the disclosure
...
[§ 4a](../appendix/who-discloses.md) has been circling since it was written. **And the
...
five or more. Entered at [the press corpus](../appendix/press-corpus.md) § 5, ⚠
...
Javorsky at [known objections](../commentary/objections.md).
...
provider."* Row at [the census](../appendix/bill-census.md), coverage at
[the press corpus](../appendix/press-corpus.md) § 6.
...
[the table of authorities](../authorities/table-of-authorities.md). The useful one: Congress swept
