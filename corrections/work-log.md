...
*The diary — the running account of what was done, found, and got wrong, day by day. Part III of
the ledger; the [errata register](./corrections.md) and [changelog](./changes.md) are beside it.*
...
this diary, the [changelog](./changes.md), and the [errata register](./corrections.md). The full
...
- **25 Aug 2026** — the day the instruments were audited by what they missed. The prose moved to
  ...
  carrying no star pagination ([E47](./corrections.md)); and *Iverson*, where two words inside a block
  quotation were not the court's, and where the sentences we had elided held the bridge to *Ahmad*
  the criminal lane had spent the day arguing around ([E48](./corrections.md)). The Guidelight control
  ...
  of the day's errata are about this project's own instruments: [E49](./corrections.md), a finding
  announced that the cure register had already made three days earlier and put in a title; and
  [E50](./corrections.md), in which an unterminated seal was found to have hidden 1,599 of the errata
  ...
  *Framing note, entered because the maintainer asked for it and because it survives being taken
  ...
  [the glossary](../authorities/glossary.md) already applies to *emergent*: does the
...
- **22 Aug 2026** — the conformance pass: [the verification record](../appendix/verification-record.md)
...
- **22 Aug 2026** — the enterprise pass: [CURE 7](../revision/proposals.md) drafts the
  covered frontier enterprise (scope follows the ecosystem, duty follows the function);
  [the coverage set](../appendix/companies-covered.md) — twelve companies, four layers, their
  own word *frontier* verbatim; [the definition](../commentary/what-frontier-means.md) and
  [known objections](../commentary/objections.md) published; the front page inverted around the
  two definitions.
- **22 Aug 2026** — the global frontier models compiled from Epoch AI data into
  [research/frontier_models.md](../appendix/models-and-compute.md), paired with the developers' own
  *frontier* self-designations (five labs by name, the METR twelve by framework);
  [CURE 6](../revision/proposals.md) proposes the self-designation route into SEC. 1(b)(1)
...
- **22 Aug 2026** — the July–August research folded into the standards: a two-column
  ...
  [the glossary](../authorities/glossary.md); the contribution ask splits into
  [three labeled doors](../README.md#who-made-this); [CURE 4](../revision/proposals.md)
  gains AI-native precedent and the queue two new open questions;
  [the press corpus](../appendix/press-corpus.md) discharges its owed items;
  *Moffatt v. Air Canada* and Desai & Riedl enter [the authorities](../authorities/table-of-authorities.md)
  as candidates.
- **21 Aug 2026** — the repository restructure: the single ledger splits into
  [errata](./corrections.md), [changelog](./changes.md) and this diary; the cite-check and census pass
  files E14–E20, including the Connecticut/California correction; the Illinois-repository incident
  logged at [E19](./corrections.md); the overnight primary-source pass opens the AISI report and the
  Government Cyber Action Plan.
- **20 Aug 2026** — [reading notes](../filed-comments/fda-2024-d-4488.md) on the 51
  FDA comments; [the field guide to filing a federal comment](../filed-comments/how-to-file.md).
- **20 Aug 2026** — [the comparative file](../commentary/other-jurisdictions.md) pins
  PRC art. 31, § 130 OWiG, and the 1890–91 export-inspection acts.
- **20 Aug 2026** — Illinois pinned: P.A. 104-0538 § 10 enters [the adopted
  texts](../authorities/adopted-standards.md); the "v4" header bracket logged as
  [E10](./corrections.md) and corrected at v3.5 rather than edited in place.
- **20 Aug 2026** — the withdrawn typeset edition replaced by a line-numbered
  ...
  outside (CURE 1); [table of authorities](../authorities/table-of-authorities.md) and
  [bracketed-matter worksheet](../act/bracketed-matter.md) published; repository archived at
  CERN with a DOI.
...
by name, twelve by published framework (METR, December 2025). [CURE 6](../revision/proposals.md)
...
responsibility and consequences." [CURE 4](../revision/proposals.md), the recast of the
...
transcription. All four were withdrawn and quarantined. Filed as [E22](./corrections.md).
...
being enters the sentence.** [House language § 10a](../authorities/house-style.md) argues that the
...
[Who has to tell you](../appendix/who-discloses.md) has evidence now, and a section that can
actually be cited.
...
[Why a signature works](../commentary/why-a-signature-works.md) offered Sarbanes-Oxley as proof that
...
[the census](../appendix/bill-census.md), which also regrades that row: the auditor line
...
script this project wrote to move its own files. [E19](./corrections.md) has it in full, including the
...
lives in [`docs/`](../commentary/): the case, the statute translated, the questions. The ledger, which had
reached 1,128 lines, is now a 49-line index over [`ledger/`](../filed-comments/index.md). Twenty page images of
...
prosecuted](../commentary/the-same-conduct.md)** gathers five American computer-crime prosecutions —
...
person](../commentary/already-a-crime.md)** answers the objection that this Act invents
...
for destroying a document. **[Why a signature works](../commentary/why-a-signature-works.md)**
collects the SEC. 8 case that had been scattered across four files. **[Who actually
files](../filed-comments/who-files.md)** counts the room where these rules are settled: fifty-one
comments, twenty-one from industry, four from the patient side. **[Does the frontier touch
medicine?](../filed-comments/frontier-ai-in-medicine.md)** answers a challenge put to the project that day
and answers it uncomfortably. And **[what these words
mean](../authorities/glossary.md)** is a glossary, opening on the question the project's
...
**Two errors of our own, logged rather than tidied.** [E17](./corrections.md) carries both: a sentence
...
**Adopted today.** A register rule, as [house language § 4](../authorities/house-style.md), after a
...
primary locator to every case-level claim. [E14](./corrections.md) carries the full disposition and
...
the locator rule adopted in [E14](./corrections.md) that same morning, that is the wrong grade. One
primary was actually fetched all day: the arXiv abstract. Everything else rested on a secondary
quoting a first party. Logged as [E15](./corrections.md), and graded above its size for one reason: the
...
**Opened today:** [the bill census](../appendix/bill-census.md), which starts from
...
**20 August 2026, sixth pass — The scene the statute was built backward from, finally written down.** A grep for the cross-examination — the CEO on the stand, *could you have stopped this*, both answers losing — found it nowhere in the repository. The statute enforces it; no explainer demonstrated it. It is now [its own section of the front page](../commentary/the-case.md#the-cross-examination), seated between the translated statute and the stories, so a reader who has just walked the fourteen sections watches them fire.
...
The fiscal seat has a document at last: [the fiscal note](../enactment/fiscal-note.md), whose lead finding is that SEC. 3(b) is the estimate — no pre-approval means no licenses, no queue, no backlog, no appeals, and a budget office reaching for a food-and-drug comparator overstates this Act by an order of magnitude. Cost tracks the number of frontier developers shipping in, not the size of the state. Every figure is a bracket; the seat is asked to review a stated basis, not invent one.

Two claims were declined today, which is the part worth keeping. A widely shared thread put the American frontier's collapsing price margin on a chart nobody in its own replies could locate; the objection is [logged in the dossier's reading notes](../appendix/dossier.md) and not one figure from it is asserted anywhere. And from the rebuilt Pork War answer, the half that hurts: inspection alone did not reopen Germany in 1891 — a threatened tariff on sugar beets did. Verifiable safety was necessary, not sufficient. A weaker sentence, and the only one that survives a hostile reader with a search engine.
...
[audit/v3_5_cure_language.md](../revision/proposals.md), CURE 1 already splice-ready:
...
wins. the [changelog](./changes.md) holds the detail; the [errata register](./corrections.md)
holds the mistakes; this page holds the project's own story. (the world's
story, plain words, is [context: summer 2026](../commentary/the-case.md); the
evidence-grade record of those dates is [the dossier timeline](../appendix/dossier.md).)
...
[behind the scenes](./work-log.md) now states the naming rules before
...
**17 aug 2026 · integrity patch.** [ERRATA.md](./corrections.md) opened — we audited our own
...
got its correction note. new page: [behind the scenes](./work-log.md).
