...
**The ledger.** [An append-only errata register](./ledger/errata.md) — forty-three entries under
numbers that reach E56, the numbers being identifiers rather than an ordering, each mistake
