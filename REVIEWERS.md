...
**The ledger.** [An append-only errata register](./ledger/errata.md) — twenty-four entries under
numbers that reach E37, the numbers being identifiers rather than an ordering, each mistake
