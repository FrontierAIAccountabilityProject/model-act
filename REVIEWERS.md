...
**The ledger.** [An append-only errata register](./ledger/errata.md) — thirty-one entries under
numbers that reach E44, the numbers being identifiers rather than an ordering, each mistake
