...
**The ledger.** [An append-only errata register](./ledger/errata.md) — thirty entries under
numbers that reach E43, the numbers being identifiers rather than an ordering, each mistake
