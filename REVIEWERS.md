...
**The ledger.** [An append-only errata register](./ledger/errata.md) — fifty entries under
numbers that reach E64, the numbers being identifiers rather than an ordering, each mistake
