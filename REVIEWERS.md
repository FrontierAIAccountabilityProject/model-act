...
**The ledger.** [An append-only errata register](./ledger/errata.md) — twenty-nine entries under
numbers that reach E42, the numbers being identifiers rather than an ordering, each mistake
