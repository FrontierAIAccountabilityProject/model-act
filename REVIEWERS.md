...
people or citizen groups who recommend a new or amended law" as one of the three recognized origins
...
first step, where nothing is scrutinized because no procedure reaches it ([the route, in
...
anything, and no organization behind the maintainer. A reviewer here is not joining an institution
...
full form: the menu worked through whole — every lane question answered, every drafted response
verified or refuted — roughly ten to twenty hours across eight weeks, adjustable. Unpaid. Your disposition is
...
**The ledger.** [An append-only errata register](./ledger/errata.md) — thirty-seven entries under
numbers that reach E50, the numbers being identifiers rather than an ordering, each mistake
...
| **Drafted in response** | [CURE 8](./audit/v3_5_cure_language.md#cure-8--sec-6-the-individual-liability-offense-reconstructed), [CURE 22](./audit/v3_5_cure_language.md#cure-22--sec-6b-the-felony-tiers-knowledge-element-and-one-word-that-is-not-american), [CURE 11](./audit/v3_5_cure_language.md#cure-11--sec-5-name-the-obligor-sec-9b-write-the-duty-in-the-active-voice), [CURE 12](./audit/v3_5_cure_language.md#cure-12--sec-5d-restore-the-scienter-its-own-donor-requires) |
...
| **Donor, 25 Aug** | **A vocabulary audit found the shelf this lane was missing.** *MacDonald & Watson*, 933 F.2d 35, 55 says official responsibility is no substitute for proof of knowledge where knowledge is an element — which is what CURE 8's Operation 4 attempts at the felony tier. *Iverson*, 162 F.3d 1015, 1026 is the answer: responsibility replaces the **act** element, not the knowledge element. And *Ahmad*, 101 F.3d 386, 391 is the attack we could not previously state — that a felony punishable by years in prison may not be a public welfare offense at all. All unread in the reporters; verifying any one of them is a finding |
...
| [CURE 4](./audit/v3_5_cure_language.md#cure-4--sec-9a-the-two-characterization-shaped-triggers-recast-as-observable-events) | The two characterization-shaped reporting triggers recast as observable events (the VW defeat-device pattern). Lands READ FIRST item 11. | **DRAFTED** | criminal · security |
...
| [CURE 15](./audit/v3_5_cure_language.md#cure-15--sec-3c2-a-disclose-and-cure-valve-because-the-text-currently-punishes-candor) | A disclose-and-cure valve, because the text currently punishes candor. | **HYPOTHESIS — sweep-derived** | enforcement |
