...
**The ledger.** [An append-only errata register](./ledger/errata.md) — sixty-one entries under
numbers that reach E75, the numbers being identifiers rather than an ordering, each mistake
